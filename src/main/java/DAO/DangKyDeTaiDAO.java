...
public class DangKyDeTaiDAO {
	private static final String INSERT_DKDTfromCN_SQL = "INSERT INTO qldetainckh.dangkydetai" + "  (MaDeTai, MaChuNhiem, MaThoiGian, TrangThai) VALUES " +
	        " (?, ?, ?,?);";
	public void dkDeTai(DangKyDeTai dk) throws SQLException {
	    ...
	    try {
	        ...
	        preparedStatement.setString(4, dk.getTrangThai());
	        preparedStatement.setInt(3, dk.getMaThoiGian());
